    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            ?>
                        ...
                        <div class="modal-dialog modal-lg modal-fullscreen-md-down">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="needs-validation" action="proses/proses_terima_order.php" method="post" novalidate>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-floating mb-3">
                                                    <input disabled type="number" class="form-control" id="jumlah" name="jumlah" placeholder="jumlah porsi" required value="<?php echo $row['jumlah'] ?>">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" name="terima_order_validate" value="12345" class="btn btn-primary">Terima Order</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <!-- Modal Terima Dapur end -->

                    <!-- Modal Siap Saji start -->
                    <div class="modal fade" id="siapSaji<?php echo $row['id_list_order'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-fullscreen-md-down">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form class="needs-validation" action="proses/proses_siap_saji.php" method="post" novalidate>
                                        <input type="hidden" name="id" value="<?php echo $row['id_list_order'] ?>">
                                        <div class="row">
                                            <div class="col-lg-8">
                                                <div class="form-floating mb-3">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            <button type="submit" name="siap_saji_validate" value="12345" class="btn btn-success">Siap Disajikan</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
